...
To stop your server once you're done testing, you can just hit `control` and `c`, at the  same time. This will work on both Macs and PCs. If you don't stop your server, you won't be able to use your terminal again to create any more directories or files, or work on any new labs. 
